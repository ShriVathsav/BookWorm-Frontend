...
export default {
    name: "ImageUploader2",
    components: {},
    props: ["maxFiles", "alterState", "inMemoryImages", "imageBlobList", "acceptMultiple", "uploadImageToBackend"],
    data() {
        return {
            uploadImageIcon,
            imageUpload2Icon,
    ...
    methods: {
        generateUrlAndBlob(files) {
            ...
            //this.alterState("inMemoryImages", this.localInMemoryImages)
            //this.alterState("imageBlobList", this.localImageBlobList)
        },
        generateBlob(file){
